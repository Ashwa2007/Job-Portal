    ...
    return (
        <DrawerPortal data-slot="drawer-portal">
            ...
            <DrawerPrimitive.Content
                ...
                className={cn(
                    'group/drawer-content bg-white dark:bg-slate-900 fixed z-50 flex h-auto flex-col border-slate-200 dark:border-slate-800',
                ...
                {...props}
            >
                <div className="bg-slate-200 dark:bg-slate-700 mx-auto my-4 h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
                {children}
            </DrawerPrimitive.Content>
        </DrawerPortal>
    );
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'flex w-full flex-col gap-1 px-6 py-4 md:mx-auto md:max-w-md border-b border-slate-100 dark:border-slate-800',
                className,
            )}
            {...props}
        />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'mt-auto grid w-full gap-2 border-t border-slate-100 dark:border-slate-800 px-6 py-4 md:mx-auto md:max-w-md',
                className,
            )}
            {...props}
        />
