                ...
                return (
                    <span
                        ...
                        style={{
                            ...
                            borderWidth: '1px',
                            borderColor: `rgba(var(--foreground), ${borderOpacity / 100})`, // Adjusted for standard CSS
                            top: '50%',
                            left: '50%',
...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
    ...
    return (
        <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
            <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-5xl md:text-7xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10'>
                {text}
            </span>
...
const AnimatedForm = memo(function AnimatedForm({
    ...
    const validateForm = (event: FormEvent<HTMLFormElement>) => {
        ...
        fields.forEach((field) => {
            const element = (event.target as HTMLFormElement)[field.label] as HTMLInputElement;
    ...
    return (
        <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
                ...
                >
                    {fields.map((field) => (
                        <section key={field.label} className='flex flex-col gap-2'>
                            <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
                                <Label htmlFor={field.label} className="dark:text-neutral-300 font-bold">
            ...
            dark:text-white rounded-md h-12 font-bold shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] 
                ...
                {textVariantButton && goTo && (
                    <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
                        <section className='mt-4 text-center'>
                            <button
                                type="button"
                                className='text-sm text-blue-500 hover:text-blue-600 font-semibold outline-none'
                                onClick={goTo}
                            >
                                {textVariantButton}
                            </button>
